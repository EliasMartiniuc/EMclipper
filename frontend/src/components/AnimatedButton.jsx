...
const AnimatedButton = ({ isSubmitting, isSuccess, ...props }) => {
  // If the form is submitting or was successful, we lock the button in the "active" animation state
  const isActive = isSubmitting || isSuccess;
...
const StyledWrapper = styled.div`
  ...
  .button {
    --primary: var(--accent-color, #8A7AED);
    --neutral-1: #ffffff;
    --neutral-2: #F7F7FA;
    --radius: 14px;
  ...
  .button.is-active p span,
  .button:focus:not(:disabled) p span {
    opacity: 1;
  ...
  .button.is-active .state--default svg,
  .button:focus:not(:disabled) .state--default svg {
    animation: takeOff 0.8s linear forwards;
  }
  
  .button.is-active .state--default .icon,
  .button:focus:not(:disabled) .state--default .icon {
  ...
  .button.is-active .state--default .icon:before,
  .button:focus:not(:disabled) .state--default .icon:before {
  ...
  .button.is-active .state--default,
  .button:focus:not(:disabled) .state--default {
    position: absolute;
  }
  
  .button.is-active .state--sent,
  .button:focus:not(:disabled) .state--sent {
    display: flex;
  }
  
  .button.is-active .state--sent span,
  .button:focus:not(:disabled) .state--sent span {
    opacity: 0;
    animation: slideDown 0.8s ease forwards calc(var(--i) * 0.2s);
  }
  
  .button.is-active .state--sent .icon svg,
  .button:focus:not(:disabled) .state--sent .icon svg {
    opacity: 0;
